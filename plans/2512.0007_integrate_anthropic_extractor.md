...
- [x] Create `tests/integration/test_anthropic_integration.py` (or extend `test_cli_workflow.py`).
- [x] Implement the Red tests (expecting failure since `main.py` isn't updated).
- [x] Update `main.py` to include `AnthropicExtractor` logic.
- [x] Verify tests pass (Green).
- [x] Refactor CLI output and error handling.
- [x] Final verification with all integration tests.
