...
| **2. Text Extraction (Basic)** | Clear English receipt | `tests/dataset/receipt_en.jpg` | String containing key English text from receipt. |
| **3. Multi-language** | CJK/English receipt | `tests/dataset/receipt_zh_tw.jpg`, `receipt_jp.jpg`, `receipt_kr.jpg` | String containing recognized characters (ZH, JA, KO). |
